...
// include
console.log('Include Div String: ', str.includes('Div')); //Include Div String: AppDividend
...

{
  ...
  console.log('Removing the first character with slice', removeFirstChar); // ppDividend
...

{
  ...
  console.log('Removing the first character with substr:', newStr); // ppDividend
